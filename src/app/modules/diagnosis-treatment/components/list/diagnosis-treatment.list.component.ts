...
@Component({
  selector: 'app-diagnosis-treatment-list',
  templateUrl: './diagnosis-treatment.list.component.html',
  styleUrls: ['./diagnosis-treatment.list.component.css']
})
export class DiagnosisAndTreatmentListComponent implements OnInit {
